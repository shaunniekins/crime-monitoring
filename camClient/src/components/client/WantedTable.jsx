    ...
    <>
      <div className="absolute w-full h-5/6 z-40 flex justify-center items-center">
        <div className="bg-white p-5 w-5/6 h-5/6 overflow-scroll relative">
          <p
            className="absolute top-3 right-8 text-xl cursor-pointer hover:text-slate-400 duration-200"
            onClick={(e) => setShowWantedTable(false)}>
            x
          </p>
          <p className="font-mono text-2xl font-bold py-3 text-slate-500">
            Reported Wanted Person (History)
          </p>
      ...
      <div className="w-full h-full bg-neutral-600 absolute z-30 opacity-30"></div>
    </>
  );
}
