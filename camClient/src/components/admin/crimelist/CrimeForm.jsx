...
export default function CrimeForm({ selected, handleModal, handleFilter }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (details.validated === "")
      return showErrorMessage("Please select validated.");
    console.log(details);
    await axios
            ...
            <div className="relative w-full flex flex-col gap-2 p-6 flex-auto">
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select
                  options={placeOpt}
                  defaultValue={{
                    label: details.type_place,
                    value: details.type_place,
                  }}
                  onChange={(e) =>
              ...
              <div className="flex gap-2">
                <div className="w-full">
                  ...
                  <Select
                    options={felonyOpt}
                    defaultValue={{
                      label: details.stages_felony,
                      value: details.stages_felony,
                    }}
                    onChange={(e) =>
              ...
              <div className="flex flex-col gap-2">
                ...
                <Select
                  options={validated}
                  onChange={(e) =>
                    setDetails({ ...details, validated: e.value })
                  }
                />
              </div>
            </div>
