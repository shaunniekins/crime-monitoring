...
export default function CrimeList({
  ...
  return (
    <div className=" bg-white w-full h-full p-5 overflow-hidden text-xs">
      {isModalOpen && (
        <CrimeForm
      ...
      <ToastContainer />
      <div className="pb-5 flex justify-start items-center">
        <Button
          isIconOnly
          variant="light"
          size="sm"
            ...
            {!reportedCrime ? (
              ...
              reportedCrime.map((crime) => (
                <tr className="border-2 text-center border-slate-100">
                  ...
                  <td className="p-1">
                    {crime.last_name + ", " + crime.first_name}
                  </td>
                  ...
                  <td className="p-1">
                    <span
                      className={`p-1 ${
                        crime.validated ? "bg-green-200" : "bg-red-200"
                      }`}>
                      {crime.validated ? "True" : "False"}
                    </span>
                  </td>
